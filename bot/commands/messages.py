...
MSG_TABLE_WAITING_COLUMN = "⏳ Waiting ({count})"
...
MSG_CONFIRM_TALLY_LINE = "### {counts}"
MSG_CONFIRM_TALLY_CONFIRMED = "✅ {count} Confirmed"
MSG_CONFIRM_TALLY_PENDING = "☑️ {count} Pending"
MSG_CONFIRM_TALLY_SIGNUPS = "({yes} Yes)"
MSG_CONFIRM_TALLY_SIGNUPS_MAYBE = "({yes} Yes, {maybe} Maybe)"

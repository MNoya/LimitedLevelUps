...
MSG_ORGANIZER_ONLY_SETTINGS = "Ask an {organizer} to change settings"
...
MSG_FEATURE_LEAD = "**Organizer:** Select the players to seat on Table 1 when the tables open"
MSG_FEATURE_BUTTON = "📌 Feature on Table 1"
MSG_FEATURE_PLAYERS_BUTTON = "Feature Players"
MSG_FEATURE_DONE = "📌 **{actor}** featured {players} on Table 1"
MSG_FEATURE_CLEARED = "📌 **{actor}** cleared the Table 1 features"

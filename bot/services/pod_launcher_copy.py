...
MSG_ON_BOTH_PODS = f"{fi.FLEXIBLE_MARKER} You are on both {{slot}} Pods: {{formats}}"
MSG_ON_SEVERAL_PODS = f"{fi.FLEXIBLE_MARKER} You are on all {{count}} {{slot}} Pods: {{formats}}"
MSG_POD_THAT_NEEDS_YOU = "If both tables are created, play in the pod that needs you most"
...
MSG_LEAVE_WHICH_POD = "Choose which Pod to leave"
BOARD_LEAVE_ALL_LABEL = "All"

...
WEEKLY_SLOTS: tuple[WeeklySlot, ...] = (
    WeeklySlot(
        WEDNESDAY, time(21, 0), CREATE_DESCRIPTION, SLOT_EMOJI_AMERICAS, CREATE_MENTIONS_LATE, send_monday_noon=True
    ),
    WeeklySlot(THURSDAY, time(14, 0), CREATE_DESCRIPTION_EARLY, SLOT_EMOJI_EU, CREATE_MENTIONS_EARLY),
    WeeklySlot(SATURDAY, time(15, 0), CREATE_DESCRIPTION_SAT, SLOT_EMOJI_SATURDAY, CREATE_MENTIONS_EARLY),
)

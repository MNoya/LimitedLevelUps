...
class PodChampionshipSeed(Base):
    ...
    `wildcard` marks the pod-season seat, which keeps its board rank and is seated inside the cut."""
    ...
    wildcard     = Column(Boolean, nullable=False, server_default=text("false"))
